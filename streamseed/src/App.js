...
class App extends React.Component {
  ...
  render() {
    ...
    return (
      <div className='App'>
        <Grid
          templateAreas={`"header header" "player chatbox" "description description" "footer footer"`}
          gridTemplateRows={'7vh 1fr 10vh 5vh'}
          gridTemplateColumns={'75vw 1fr'}
          h='100vh'
          gap='0'
        ...
        >
          ...
          <GridItem
            pl='2'
            /*bg='yellow.300'*/ area={'description'}
              ...
              <HStack spacing='4vw' w='100%' h='100%'>
                ...
                <Box width='50%' pb='8vh' className='DescriptionBox'>
                  <Text textAlign='left' p='2'>
                    Welcome to my awesome stream, and thanks for reading my
                    awesome description!
                  </Text>
                </Box>
              </HStack>
